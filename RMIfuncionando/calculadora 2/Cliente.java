...
public class Cliente {
	private static final String IP = "localhost"; // Establecemos el puerto
	...
	public static void main(String[] args) throws RemoteException, NotBoundException {
		...
		Interfaz interfaz = (Interfaz) registry.lookup("Calculadora"); //Buscar la interfaz
		...
		do {
			...
			try {//tratamos de leer el entero digitado por teclado
		    	...
		    	if(eleccion != 100){
			        ...
			        System.out.println("Presiona enter para continuar realizar otra operacion");
			        sc.nextLine();
        		}
        	} while (eleccion != 100);
    	}
